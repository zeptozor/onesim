        ...
        <div className='w-full bg-white fixed left-0 bottom-0 sm:hidden h-[50px] px-20 flex items-center justify-between'>
            ...
            <div className='flex items-center flex-col gap-7'>
                <div className='w-[15px] h-[15px]'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="17" viewBox="0 0 18 17" fill="none">
                        <path d="M9 7.66667V11.8333M9 16C4.85786 16 1.5 12.6421 1.5 8.5C1.5 4.35786 4.85786 1 9 1C13.1421 1 16.5 4.35786 16.5 8.5C16.5 12.6421 13.1421 16 9 16ZM9.0415 5.16667V5.25L8.9585 5.24998V5.16667H9.0415Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
