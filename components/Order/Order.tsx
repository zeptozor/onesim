...
export function Details() {
    return (
        <div className='w-full p-20 flex flex-col gap-20 rounded bg-bg'>
...
export default function Order() {
    return (
        <div className='w-full md:min-w-[500px] flex flex-col gap-20'>
            ...
            <div className='flex flex-col rounded bg-bg p-20 gap-20'>
                <div className='w-full flex flex-col p-20 gap-20 bg-[#EEF0F4] rounded'>
                    ...
                    <div className='hidden w-full md:flex items-center justify-center p-[12px] font-semibold rounded bg-orange text-white'>Добавить</div>
                </div>
                <div className='flex flex-wrap w-full sm:justify-between gap-10'>
                    <Method icon='stripe' />
                    <Method icon='visa' />
                ...
                <div className='flex md:hidden flex-wrap w-full gap-10'>
                    <Method icon='stripe' />
                    <Method icon='visa' />
                    <Method icon='mastercard' />
                    <Method icon='amex' />
