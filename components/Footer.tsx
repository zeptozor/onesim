        ...
        <div className='w-full bg-bg'>
            <div className='flex max-w-[1500px] mx-auto w-full flex-col sm:flex-row sm:flex-wrap'>
                <div className='flex flex-col sm:flex-row w-full px-20 sm:px-80 py-40 gap-20 bg-bg'>
                    ...
                    <table className='hidden sm:block border-collapse'>
                        <thead>
                            <tr>
                                <td className='pr-[50px]'><div className='font-semibold leading-120'>ЮРИДИЧЕСКАЯ ИНФОРМАЦИЯ</div></td>
                                <td><div className='font-semibold leading-120'>ПОДДЕРЖКА КЛИЕНТОВ</div></td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td><div className='leading-120'>Политика конфиденциальности</div></td>
                                <td><div className='leading-120'>Справочный центр</div></td>
                            </tr>
                            <tr>
                                <td><div className='leading-120'>Условия и положения</div></td>
                                <td><div className='leading-120'>Связаться с нами</div></td>
                            </tr>
                        </tbody>
                    </table>
                    <div className='sm:hidden flex flex-col w-[287px] gap-20'>
                    ...
                    <div className='sm:hidden flex flex-col w-[286px] gap-20'>
