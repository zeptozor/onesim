...
function ProgressBar({ value, content }: {value: number, content: string}) {
    return (
        <div className='block relative w-full h-5'>
            ...
            <progress className='w-full appearance-none bg-[#E1E5EC] h-full rounded [&::-moz-progress-bar]:bg-orange' max={100} value={value} />
        </div>
    )
}
