...
export default function Head() {
    return (
        <div className='w-full mb-40 bg-cover bg-[url("../public/images/catalogs/mobile.svg")] sm:bg-[url("../public/images/catalogs/desktop.svg")]'>
            <div className='w-full max-w-[1500px] mx-auto px-20 sm:px-40 md:px-80 py-40'>
